    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400 mt-1">Manage all your shops</p>
        </div>
        <button
            ...
            <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
              {filteredShops.map((shop) => (
                ...
                >
                  ...
                  <td className="px-6 py-4 text-gray-900 dark:text-white">{shop.category}</td>
                  <td className="px-6 py-4 text-gray-900 dark:text-white">{shop.city}</td>
                  <td className="px-6 py-4">
